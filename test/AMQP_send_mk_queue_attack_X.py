...
if __name__ == "__main__":
    broker_url = "amqp://192.168.0.30:61616"  # 브로커 주소
    # queue_name = """' " ; -- /* */ # @ % ^ & * ( ) < > { } [ ] ! ~ | \ / = + -"""                   # 생성할 큐 이름
    # queue_name = """?input<script>alert('test')</script>"""                  # 생성할 큐 이름
    queue_name = """ $admin1 " admion"""                  # 생성할 큐 이름
#     queue_name = "test1234"
#     &#60;&#47;&#108;&#105;&#62;&#60;&#108;&#105;&#62;hello&#60;&#47;&#108;&#105;&#62;&#60;&#108;&#105;&#62;
    ...
    #
    # while True:
    #     queue_name_r = queue_name + str(count)
    #     try:
    #         container = Container(QueueCreator(broker_url, queue_name_r))
    #         container.run()  # 이벤트 루프 실행
    #         time.sleep(0.1)  # 잠시 대기 후 다음 큐 생성
    #         count += 1
    #
    ...
    #         break
    #
    # print(f"Total queues created: {count}")
